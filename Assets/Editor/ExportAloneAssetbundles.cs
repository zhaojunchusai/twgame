...
/// 打包独立资源-场景
/// </summary>
class ExportAloneAssetbundles : ExportCommand
{
    private const string PRE_STRING = "aloneres";
    ...
    private void BuildAloneAssetbundle(string prefabPath)
    {
        ...
        string path = AssetbundleDetailPath(AssetBundleResType.AloneRes) + PRE_STRING + "_" + prefab.name + ".assetbundle";
