...
public class RankviewConfig : BaseConfig
{
    ...
    public RankviewConfig()
    {
        _datas = new Dictionary<uint,RankviewData>();
        Initialize(GlobalConst.Config.DIR_XML_RANKVIEW, ParseConfig);
    }

    public uint GetRankIDByType(RankType type)
    {
