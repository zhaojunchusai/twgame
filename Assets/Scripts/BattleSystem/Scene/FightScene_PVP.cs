...
/// 演武场
/// </summary>
public class FightScene_PVP : FightSceneBase
{
    /// <summary>
    /// 路径数量
    /// </summary>
    ...
    public override bool Operate_Victory()
    {
        ...
        PVPModule.Instance.SendArenaReward(ArenaResult.AR_WIN, 1, "d");
    ...
    public override bool Operate_Failure()
    {
        ...
        PVPModule.Instance.SendArenaReward(ArenaResult.AR_LOSE, 1, "d");
        CommandManager.Instance.SendSingleCommand(MessageID.Message_Fight.FM_FightFinished, new FightFinishedInfo(_SceneStatus, 0));
        return true;
    }
