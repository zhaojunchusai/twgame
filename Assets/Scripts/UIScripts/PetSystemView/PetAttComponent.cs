...
using UnityEngine;
public class PetAttComponent : BaseComponent
{
    ...
    {
        base.MyStart(root);
        Lbl_AttValue = mRootObject.transform.FindChild("Label").GetComponent<UILabel>();
        Spt_AttIcon = mRootObject.transform.FindChild("Icon").GetComponent<UISprite>();
    }
