...
public class SkillItemComponent : MonoBehaviour
{
    ...
    public delegate void TouchDeleget(SkillItemComponent comp);
    ...
    public void SetInfo(Skill sk)
    {
        ...
        if (mark_canUpLv)
        {
            if (sk.enableStrong() == SkillCheck.Ok)
                mark_canUpLv.SetActive(true);
            else
                mark_canUpLv.SetActive(false);
            if(this.skill.soldier == null && !CommonFunction.CheckIsOpen(OpenFunctionType.HeroSkillControl))
            {
                mark_canUpLv.SetActive(false);
            }
        }
        ...
        if(this.skill.soldier == null)
        {
            ...
            {
                CommonFunction.SetGameObjectGray(this._root, true);
            }
            else
            {
                CommonFunction.SetGameObjectGray(this._root, false);
            }
        }
    }
}
