...
public class ChoosePrisonView
{
    public static string UIName ="ChoosePrisonView";
    public GameObject _uiRoot;
    public UILabel CostGroup_Lbl_Label;
    ...
    {
        _uiRoot =  GameObject.Find("UISystem/UICamera/Anchor/Panel/ChoosePrisonView");
        CostGroup_Lbl_Label = _uiRoot.transform.FindChild("CostGroup/Label").gameObject.GetComponent<UILabel>();
