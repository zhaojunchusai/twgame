...
public class UIWrapContentEditor : Editor
{
	public override void OnInspectorGUI ()
	{
        ...
        NGUIEditorTools.DrawProperty("Item SizeD", serializedObject, "itemSizeD", GUILayout.Width(120F));
        ...
        GUILayout.BeginHorizontal();
        SerializedProperty sp3 = NGUIEditorTools.DrawProperty("withCount", serializedObject, "wideCount", GUILayout.Width(130f));
        NGUIEditorTools.SetLabelWidth(70f);

        SerializedProperty sp4 = NGUIEditorTools.DrawProperty("highCount", serializedObject, "highCount", GUILayout.Width(120));
        NGUIEditorTools.SetLabelWidth(90f);
        GUILayout.EndHorizontal();
